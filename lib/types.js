    ...
    write: (obj, struct, writer, ver) => {
        ...
        struct.forEach(function(item) {
            if (Array.isArray(item.type)) {
                ...
                if (item.check && obj[item.name] === null) {
                    types.ULong.write(4, writer, ver);
                } else {
...
types.RecSettingData = {
    ...
    struct: ver => {
        var struct = [
            ...
            { name: "useMarginFlag", type: types.UChar },
            { name: "startMargin", type: types.Int },
            { name: "endMargin", type: types.Int },
...
types.EpgSearchKeyInfo = {
    ...
    struct: ver => {
        var struct = [
            ...
            { name: "notContentFlag", type: types.UChar },
...
types.NotifySrvInfo = {
    ...
    struct: () => {
        var struct = [
            { name: "notifyID", type: types.ULong },
            { name: "time", type: types.SystemTime },
            { name: "param1", type: types.ULong },
            { name: "param2", type: types.ULong },
            { name: "param3", type: types.ULong },
            { name: "param4", type: types.WString },
            { name: "param5", type: types.WString },
            { name: "param6", type: types.WString }
        ];
        return struct;
    }
};
